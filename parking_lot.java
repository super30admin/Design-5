//Design a parking lot system where you need to provide a token
// with the parking space number on it to each new entry for the space closest to the entrance. 
