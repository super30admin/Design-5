//use min heap to check nearest empty slot. //Remove for minHeap when someone park  and add into minheap when someone unpark .
//PriorityQueue is used to implement min  heap in java
...
public class ParkingLot {
	...
	private PriorityQueue<ParkingSpace> pq = new PriorityQueue<ParkingSpace>(new Comparator<ParkingSpace>(){
		
	        public int compare(ParkingSpace o1, ParkingSpace o2){
	        	if(o1.getFloor() == o2.getFloor()) return o1.getSlot() - o2.getSlot();
				else return o1.getFloor() - o2.getFloor();					
			}
	    });
