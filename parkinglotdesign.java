...
time complexity: O(maxFloors * maxSlotsPerFloor)
space complexity: O(maxFloors * maxSlotsPerFloor)


//using a priority queue, we can maintain the parking spaces near to the entrance and generate a token based on it
