// Q. Design a parking lot system where you need to provide a token with the parking space number
...
class DesignParkingLot {
    public static void main (String[] args) {
        ...
        System.out.println("Parked at Floor: " + n.getFloor() + ", Slot: " + n.getSpot()); // 1 1
        pl.park();
        ParkingSpot n2 = pl.getNextAvailable();
        System.out.println("Parked at Floor: " + n2.getFloor() + ", Slot: " + n2.getSpot()); //1 2
        pl.unpark(1, 1);
        ParkingSpot n1 = pl.getNextAvailable();
        System.out.println("Parked at Floor: " + n1.getFloor() + ", Slot: " + n1.getSpot()); // 1 1
    }
